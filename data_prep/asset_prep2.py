...
import copy
import os
CURRENT_PATH = 'C:/Users/cody_/Documents/GitHub/BRC/data_prep/'
...
def read_and_clean(ind, data):
    ...
    """
    if data == 'inv':
        fname = os.path.join(CURRENT_PATH, 'detailnonres_inv.xlsx')
    elif data == 'stock':
        fname = os.path.join(CURRENT_PATH, 'detailnonres_stk.xlsx')
    else:
...
resinv = pd.read_excel(CURRENT_PATH + 'detailresidential.xlsx', sheet_name='Investment ', header=5)
...
resstk = pd.read_excel(CURRENT_PATH + 'detailresidential.xlsx', sheet_name='Net Stock (Current-Cost)', header=5)
...
firm_inv = pd.read_excel(CURRENT_PATH + 'nonres_firm_inv.xls', sheet_name='Sheet0', header=5)
...
firm_stk = pd.read_excel(CURRENT_PATH + 'nonres_firm_stk.xls', sheet_name='Sheet0', header=5)
...
investment_corp.to_csv(CURRENT_PATH + 'investment_corp.csv')
...
investment_ncorp.to_csv(CURRENT_PATH + 'investment_ncorp.csv')
...
capital_corp.to_csv(CURRENT_PATH + 'capital_corp.csv')
...
capital_ncorp.to_csv(CURRENT_PATH + 'capital_ncorp.csv')
